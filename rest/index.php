...
if (!Access::check_network('init-api', $user, 5)) {
    debug_event('rest/index', 'Unauthorized access attempt to Subsonic API [' . filter_input(INPUT_SERVER, 'REMOTE_ADDR', FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES) . ']', 3);
    ob_end_clean();
