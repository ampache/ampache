...
<div id="sidebar_home" class="w3-container">
	  ...
	  {{ $_COOKIE['sb_music'] }}">Music
	   ...
	   <div id="sb_music" class="w3-animate-left w3-2017-neutral-grey">
  		...
  		<a href="#" class="w3-btn w3-block w3-left-align w3-tiny w3-text-gray" style="height:22px;">Artists</a>
  		<a href="#" class="w3-btn w3-block w3-left-align w3-tiny w3-text-gray" style="height:22px;">Albums</a>
  		<a href="#" class="w3-btn w3-block w3-left-align w3-tiny w3-text-gray" style="height:22px;">Tagcloud</a>
  		<a href="#" class="w3-btn w3-block w3-left-align w3-tiny w3-text-gray" style="height:22px;">Playlists</a>
  		<a href="#" class="w3-btn w3-block w3-left-align w3-tiny w3-text-gray" style="height:22px;">Smart Playlists</a>
 		<a href="#" class="w3-btn w3-block w3-left-align w3-tiny w3-text-gray" style="height:22px;">Channels</a>
	   ...
	   <div id="sb_video" class="w3-animate-left">
  		...
  		<a href="#" class="w3-btn w3-block w3-left-align w3-tiny w3-text-gray" style="height:22px;">TV Shows</a>
  		<a href="#" class="w3-btn w3-block w3-left-align w3-tiny w3-text-gray" style="height:22px;">Movies</a>
  		<a href="#" class="w3-btn w3-block w3-left-align w3-tiny w3-text-gray" style="height:22px;">Personal Videos</a>
	   ...
	   {{ $_COOKIE['sb_information'] }}">Information
	    <i class="fa fa-caret-down"></i></button>
	     <div id="sb_information" class="w3-animate-left">
  		    ...
  		    <a href="#" class="w3-btn w3-block w3-tiny w3-left-align w3-text-gray" style="height:22px;">Newest</a>
	   ...
	   {{ $_COOKIE['sb_random'] }}">Random
	    <i class="fa fa-caret-down"></i></button>
	     <div id="sb_random" class="w3-animate-left">
  		    ...
  		    <a href="#" class="w3-btn w3-block w3-tiny w3-left-align w3-text-gray" style="height:22px;">Artist</a>
  		    <a href="#" class="w3-btn w3-block w3-tiny w3-left-align w3-text-gray" style="height:22px;">Album</a>
  		    <a href="#" class="w3-btn w3-block w3-tiny w3-left-align w3-text-gray" style="height:22px;">Album</a>
   		    <a href="#" class="w3-btn w3-block w3-tiny w3-left-align w3-text-gray" style="height:22px;">Playlist</a>
  	     </div>
 </div>
