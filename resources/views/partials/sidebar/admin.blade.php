...
<div id="sidebar_admin">
  ...
  @hasrole('Administrator')
	...
	<div id="sb_server" class="w3-animate-left w3-text-sidebar w3-margin-left">
  		...
  		<a href="{!! url('/preference', 'options') . '/edit' !!}" class="w3-btn w3-block w3-left-align" style="height:24px;font-size:12px;">Options</a>
   		<a href="{!! url('/preference', 'playlist') . '/edit' !!}" class="w3-btn w3-block w3-left-align" style="height:24px;font-size:12px;">Playlist</a>
  		<a href="{!! url('/preference', 'streaming') . '/edit' !!}" class="w3-btn w3-block w3-left-align" style="height:24px;font-size:12px;">Streaming</a>
 		<a href="{!! url('/preference', 'system') . '/edit' !!}" class="w3-btn w3-block w3-left-align" style="height:24px;font-size:12px;">System</a>
  	</div>
  	@endhasrole
</div>
