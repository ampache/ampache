<div id="sidebar_modules">
	...
	<i class="fa fa-caret-down"></i></button>
		<div id="sb_modules" class="w3-animate-left w3-text-sidebar  w3-margin-left">
  		...
  		<a href="{!! url('/modules/localplay/index') !!}" class="w3-btn w3-block w3-left-align w3-text-sidebar" style="height:24px;font-size:12px;">Localplay Modules</a>
  		<a href="{!! url('/modules/plugin/index') !!}" class="w3-btn w3-block w3-left-align w3-text-sidebar" style="height:24px;font-size:12px;">Available Plugins</a>
	</div>
