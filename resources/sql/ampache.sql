...
CREATE TABLE IF NOT EXISTS `playlist_folder` (
  ...
  `last_update` int(11) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_playlist_folder` (`user`,`parent`,`name`),
  KEY `user_parent_IDX` (`user`,`parent`,`sort_order`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `playlist_folder_map`
--

DROP TABLE IF EXISTS `playlist_folder_map`;
CREATE TABLE IF NOT EXISTS `playlist_folder_map` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user` int(11) unsigned NOT NULL,
  ...
  KEY `user_folder_IDX` (`user`,`folder`,`sort_order`),
  KEY `object_type_id_IDX` (`object_type`,`object_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('5', '-1', 'public', '0', '0', '[[\"artistrating\",\"equal\",\"5\",null]]', 'probe-restored', 'AND', '0', '0', NULL, NULL, 'System', NULL),
...
('12', '1', 'public', '0', '0', '[[\"albumrating\",\"equal\",\"3\",null]]', 'Album 3*', 'and', '0', '0', '0', '0', 'admin', NULL),
('13', '-1', 'public', '0', '0', '[[\"albumrating\",\"equal\",\"2\",null]]', 'Album 2*', 'AND', '0', '0', '0', '0', 'System', NULL),
('14', '-1', 'public', '0', '0', '[[\"albumrating\",\"equal\",\"1\",null]]', 'Album 1*', 'AND', '0', '0', '0', '0', 'System', NULL),
