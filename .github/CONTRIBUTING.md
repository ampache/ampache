...
Please read [Development section](https://ampache.org/docs/development/CONTRIBUTING).
...
Please add [some logs](ampache.org/docs/help/#enable-logging) with your new issue.
