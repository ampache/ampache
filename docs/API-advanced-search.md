...
| Base Rules            | Title                                   | Operator Type     |                              Valid Types                              |
|-----------------------|-----------------------------------------|-------------------|:---------------------------------------------------------------------:|
| anywhere              | Any searchable text                     | text              |                                 song                                  |
| none                  | Empty / No rule search                  | is_true           |                                 song                                  |
| title                 | Title / Name                            | text              | song, album, artist, label, playlist, podcast, podcast_episode, genre |
| name                  | (*Alias of title)                       |                   |                                                                       |
...
| Play History              | Title                     | Operator Type     |                  Valid Types                  |
|---------------------------|---------------------------|-------------------|:---------------------------------------------:|
...
| Musicbrainz | Title                   | Operator Type |     Valid Types     |
|-------------|-------------------------|---------------|:-------------------:|
