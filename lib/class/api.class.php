...
class Api
{
    ...
    public const METHOD_LIST = [
        ...
        'tags' => ApiMethods\Tags::class,
        'tag' => ApiMethods\Tag::class,
        'tag_artists' => ApiMethods\TagArtists::class,
        'tag_albums' => ApiMethods\TagAlbums::class,
        'tag_songs' => ApiMethods\TagSongs::class,
