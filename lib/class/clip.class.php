...
class Clip extends Video
{
    ...
    {
        debug_event('clip.class', 'insert ' . print_r($data,true) , 5);
        ...
        if ($artist_id || $song_id) {
            debug_event('clip.class', 'insert ' . print_r(['artist_id' => $artist_id,'song_id' => $song_id],true) , 5);
    ...
    {
        debug_event('clip.class', 'update ' . print_r($data,true) , 5);
        $artist_id = self::_get_artist_id($data);
        $song_id   = Song::find($data);
        debug_event('clip.class', 'update ' . print_r(['artist_id' => $artist_id,'song_id' => $song_id],true) , 5);
