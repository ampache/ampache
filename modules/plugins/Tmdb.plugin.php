...
class AmpacheTmdb {
    ...
    public function get_metadata($gather_types, $media_info) {
        ...
        try {
            ...
            $secure = (bool) AmpConfig::get('tmdb_secure') ? (bool) AmpConfig::get('tmdb_secure') : true ;
            $client = new \Tmdb\Client($token, null, ['secure' => $secure]);
           ...
           if (in_array('movie', $gather_types)) {
            ...
            if (in_array('tvshow', $gather_types)) {
                ...
                $results['tvshow'] = $tvshow->getOriginalName();
                ...
                if ($results['tvshow_season']) {
                    ...
                    if ($release['id']) {
                        ...
                        $results['original_name'] = $episode['name'];
                        if ($episode['air_date']) {
