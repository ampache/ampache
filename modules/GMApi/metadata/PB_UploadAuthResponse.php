...
class PB_UploadAuthResponse extends PB_Message_Abstract {
	...
	public function __construct() {
		...
		$this->setField("u1", PhpBuf_Type::INT, PhpBuf_Rule::OPTIONAL, 11);
		$this->setField("u2", PhpBuf_Type::INT, PhpBuf_Rule::OPTIONAL, 12);
	}
