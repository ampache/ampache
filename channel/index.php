        ...
        if ($auth['success']) {
            ...
            if (AmpConfig::get('access_control')) {
                if (!Access::check_network('stream', Core::get_global('user')->id, '25') &&
                    ...
                    debug_event('channel/index', "UI::access_denied: Streaming Access Denied: " . filter_input(INPUT_SERVER, 'REMOTE_ADDR', FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES) . " does not have stream level access", 2);
                    UI::access_denied();
