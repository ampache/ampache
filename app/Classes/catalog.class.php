...
abstract class Catalog 
{
    ...
    {
        DB::table('catalog')->where('catalog_type', $this->get_type())->delete();
        Schema::drop('catalog_' . $this->get_type());
...
//                debug_event('catalog', 'Missing class for ' . $file, 3);
    ...
    {
        $video_pattern = "/\.(" . config('catalog.catalog_video_pattern') . ")$/i";
    ...
    {
        $playlist_pattern = "/\.(" . config('catalog.catalog_playlist_pattern') . ")$/i";
