...
class vaInfo
{
    ...
    public function __construct($file, $gather_types = array(), $encoding = null, $encoding_id3v1 = null, $encoding_id3v2 = null, $dir_pattern = '', $file_pattern ='', $islocal = true)
    {
        ...
        $this->encoding     = $encoding ?: config('system.site_charset');
        ...
        if (in_array('getID3', $enabled_sources) && $this->islocal) {
            ...
            if (config('system.mb_detect_order')) {
                $mb_order = config('system.mb_detect_order');
            ...
            if (config('system.getid3_detect_id3v2_encoding')) {
    ...
    {
        $order = (array) config('catalog.' . $config_key);
...
//                        //debug_event('vainfo', 'Cleaning vorbis', 5);
    ...
    public function set_broken()
    {
        ...
        $order = config('catalog.tag_order');
    ...
    private function parseGenres($data)
    {
        ...
        $delimiters = config('catalog.additional_genre_delimiters');
