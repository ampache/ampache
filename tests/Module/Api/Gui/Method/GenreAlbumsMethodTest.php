...
class GenreAlbumsMethodTest extends MockeryTestCase
{
    ...
    private ?GenreAlbumsMethod $subject;
    ...
    public function setUp(): void
    {
        ...
        $this->subject = new GenreAlbumsMethod(
            $this->streamFactory,
            $this->userRepository,
            $this->tagRepository
        );
    ...
    public function testHandleReturnsResult(): void
    {
        ...
        $this->subject->handle(
            ...
            $response,
            $output,
            ['filter' => (string) $filterId, 'limit' => (string) $limit, 'offset' => (string) $offset]
        );
    }
}
