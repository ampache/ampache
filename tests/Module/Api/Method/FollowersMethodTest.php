...
/**
 * Resolving the lead user goes through the User::get_from_id()/User::get_from_username() database
 * statics, so only the config gate can be exercised without a database fixture.
 */
class FollowersMethodTest extends MockeryTestCase
{
    private ConfigContainerInterface|MockInterface|null $configContainer;
    private ModelFactoryInterface|MockInterface|null $modelFactory;
    private ?FollowersMethod $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new FollowersMethod(
