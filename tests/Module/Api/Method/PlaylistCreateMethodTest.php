...
/**
 * Creating the playlist goes through the Playlist::create() database static, so only the missing
...
class PlaylistCreateMethodTest extends MockeryTestCase
{
    ...
    public function testHandleThrowsIfNameIsMissing(int $apiVersion): void
    {
        ...
        $this->expectExceptionMessage(sprintf(T_('Bad Request: %s'), 'name'));
