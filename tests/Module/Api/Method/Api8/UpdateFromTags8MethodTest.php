...
class UpdateFromTags8MethodTest extends MockeryTestCase
{
    private MockInterface|PrivilegeCheckerInterface|null $privilegeChecker;
    private ?UpdateFromTags8Method $subject;
    ...
    public function testHandleThrowsIfAccessDenied(): void
    {
        ...
        $this->subject->handle(
            ...
            $response,
            $output,
            ['filter' => '123', 'type' => 'song', 'api_format' => 'json', 'auth' => 'some-auth'],
            $user,
            8
        );
    }
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new UpdateFromTags8Method(
