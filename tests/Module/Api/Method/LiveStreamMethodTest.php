...
class LiveStreamMethodTest extends MockeryTestCase
{
    private ConfigContainerInterface|MockInterface|null $configContainer;
    private ModelFactoryInterface|MockInterface|null $modelFactory;
    private ?LiveStreamMethod $subject;
    ...
    public function testHandleReturnsResult(int $apiVersion): void
    {
        ...
        $user       = $this->mock(User::class);
        $stream     = $this->mock(StreamInterface::class);
        $item       = $this->mock(Live_Stream::class);
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new LiveStreamMethod(
