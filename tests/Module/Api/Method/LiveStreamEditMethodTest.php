 ...
 */
class LiveStreamEditMethodTest extends MockeryTestCase
{
    private ModelFactoryInterface|MockInterface|null $modelFactory;
    private MockInterface|PrivilegeCheckerInterface|null $privilegeChecker;
    private ?LiveStreamEditMethod $subject;
    ...
    public function testHandleThrowsIfLiveStreamIsNotFound(int $apiVersion): void
    {
        ...
        $liveStream->shouldReceive('isNew')
            ->withNoArgs()
            ->once()
            ->andReturnTrue();
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new LiveStreamEditMethod(
            $this->modelFactory,
