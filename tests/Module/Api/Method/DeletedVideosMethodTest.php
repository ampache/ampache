...
/**
 * The result paths of this method go through the Video::get_deleted() database static, so only
 * the config gate can be exercised without a database fixture.
 */
class DeletedVideosMethodTest extends MockeryTestCase
{
    private ConfigContainerInterface|MockInterface|null $configContainer;
    private ?DeletedVideosMethod $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new DeletedVideosMethod(
