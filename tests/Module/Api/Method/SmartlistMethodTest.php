...
class SmartlistMethodTest extends MockeryTestCase
{
    private ModelFactoryInterface|MockInterface|null $modelFactory;
    private ?SmartlistMethod $subject;
    ...
    /**
     * The `smart_` prefix is stripped before the search is looked up
     */
    #[DataProvider(methodName: 'apiVersionProvider')]
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new SmartlistMethod(
            $this->modelFactory
        );
    }
}
