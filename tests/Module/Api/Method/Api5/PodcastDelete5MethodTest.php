...
class PodcastDelete5MethodTest extends TestCase
{
    ...
    private PodcastDelete5Method $subject;
    ...
    public function testHandleDeletes(): void
    {
        ...
        $this->output->expects(static::once())
            ->method('success')
            ->with(5, sprintf('podcast %d deleted', $podcastId))
            ->willReturn($result);
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new PodcastDelete5Method(
            $this->podcastDeleter,
