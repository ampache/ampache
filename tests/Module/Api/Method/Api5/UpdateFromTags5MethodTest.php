...
class UpdateFromTags5MethodTest extends MockeryTestCase
{
    ...
    private ?UpdateFromTags5Method $subject;

    public function testHandleReachesParameterCheckOnceGranted(): void
    {
        ...
        $this->subject->handle(
            ...
            $response,
            $output,
            ['id' => '123', 'api_format' => 'json', 'auth' => 'some-auth'],
            $user,
            5
        );
    }

    public function testHandleThrowsIfAccessDenied(): void
    {
        $gatekeeper = $this->mock(GatekeeperInterface::class);
        $response   = $this->mock(ResponseInterface::class);
        $output     = $this->mock(ApiOutputInterface::class);
        ...
        $this->subject->handle(
            ...
            $response,
            $output,
            ['id' => '123', 'type' => 'song', 'api_format' => 'json', 'auth' => 'some-auth'],
            $user,
            5
        );
    }
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new UpdateFromTags5Method(
            $this->streamFactory,
