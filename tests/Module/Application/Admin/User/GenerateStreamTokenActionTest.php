...
class GenerateStreamTokenActionTest extends TestCase
{
    ...
    private GenerateStreamTokenAction $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new GenerateStreamTokenAction(
            $this->requestParser,
            $this->ui,
            $this->modelFactory,
