...
class DeleteAvatarActionTest extends MockeryTestCase
{
    ...
    private DeleteAvatarAction $subject;
    ...
    public function setUp(): void
    {
        ...
        $this->subject = new DeleteAvatarAction(
            $this->ui,
            $this->modelFactory,
    ...
    public function testRunDeletes(): void
    {
        ...
        $user->shouldReceive('delete_avatar')
            ->withNoArgs()
            ->once();
