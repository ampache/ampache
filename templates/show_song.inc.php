...
<?php
  ...
  $songprops[gettext_noop('Original Year')] = scrub_out($song->get_album_original_year());
  ...
  $songprops[gettext_noop('Catalog Number')] = scrub_out($song->get_album_catalog_number());
  $songprops[gettext_noop('Barcode')]        = scrub_out($song->get_album_barcode());
