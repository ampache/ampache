...
<?php foreach ($object_ids as $data) {
    ...
    <div class="tag_container">
        <div class="tag_button">
            <span id="click_tag_<?php echo $data['id'];
    ?>"><?php echo $data['name'];
    ?></span>
    ...
    ?>
                ...
                <li>
                    <a class="tag_delete" href="<?php echo AmpConfig::get('ajax_url') ?>?page=tag&action=delete&tag_id=<?php echo $data['id'];
    ?>" onclick="return confirm('<?php echo T_('Do you really want to delete the tag?');
...
<?php if (!count($object_ids)) {
    ?>
<span class="fatalerror"><?php echo T_('Not Enough Data');
    ?></span>
<?php 
} ?>
