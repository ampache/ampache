    ...
    <div class="tag_container">
        ...
        <div class="tag_actions">
            <ul>
                ...
                <li>
                    <a class="tag_delete" href="<?php echo AmpConfig::get('ajax_url') ?>?page=tag&action=delete&tag_id=<?php echo $data['id']; ?>" onclick="return confirm('<?php echo sprint_f(T_('Do you really want to delete this %s?'), T_('Tag')); ?>');"><?php echo UI::get_icon('delete', T_('Delete')); ?></a>
                </li>
            </ul>
        </div>
    <?php
