...
<ul class="sb2" id="sb_home">
    <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Browse Music'); ?>"><?php echo T_('Music'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'browse_music', 'header-img ' . ($_COOKIE['sb_browse_music'] == 'collapsed') ? 'collapsed' : 'expanded'); ?></h4></li>
        <?php
    ...
    <?php if (AmpConfig::get('allow_video') && Video::get_item_count('Video')) {
            ?>
        <li><h4 class="header"><span class="sidebar-header-title"><?php echo T_('Video') ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'browse_video', 'header-img ' . ($_COOKIE['sb_browse_video'] == 'collapsed') ? 'collapsed' : 'expanded'); ?></h4>
    ...
    <?php if (Access::check('interface', '25')) {
        ?>
    <li>
    <h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Playlist'); ?>"><?php echo T_('Playlist'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'playlist', 'header-img ' . ($_COOKIE['sb_home_playlist'] == 'collapsed') ? 'collapsed' : 'expanded'); ?></h4>
    ...
    <li>
        <h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Information'); ?>"><?php echo T_('Information'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'information', 'header-img ' . ($_COOKIE['sb_info'] == 'collapsed') ? 'collapsed' : 'expanded'); ?></h4>
    ...
    <li>
        <h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Random'); ?>"><?php echo T_('Random'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'random', 'header-img ' . ($_COOKIE['sb_random'] == 'expanded') ? 'expanded' : 'collapsed'); ?></h4>
    ...
    <li>
        <h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Search'); ?>"><?php echo T_('Search'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'search', 'header-img ' . ($_COOKIE['sb_search'] == 'expanded') ? 'expanded' : 'collapsed'); ?></h4>
