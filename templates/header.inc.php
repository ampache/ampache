            ...
            <div id="header" class="header-<?php echo AmpConfig::get('ui_fixed') ? 'fixed' : 'float'; ?>"><!-- This is the header -->
                ...
                <div id="headerbox">
                    ...
                    <?php
                            ...
                            ?>
                        <span id="loginInfo">
                            <a href="<?php echo $web_path; ?>/login.php"><?php echo T_('Login'); ?></a>
                        <?php
                            if (AmpConfig::get('allow_public_registration') && Mailer::is_mail_enabled()) {
                                ?>
                                / <a href="<?php echo $web_path; ?>/register.php"><?php echo T_('Register'); ?></a>
                        <?php
                            } ?>
                        </span>
                    <?php
                    ...
                    if (Access::check('interface', '100')) {
                        ...
                        if (AmpConfig::get('int_config_version') > AmpConfig::get('config_version')) {
                            ...
                            <div class="fatalerror">
                                ...
                                <br />
                                <a href="<?php echo $web_path; ?>/admin/system.php?action=generate_config"><?php echo T_('Download a new config file to manually update'); ?></a> |
                                <a href="<?php echo $web_path; ?>/admin/system.php?action=write_config"><?php echo T_('Write a new config file directly to disk'); ?></a>
                            </div>
                <?php
                        }
                        echo '</div>';
