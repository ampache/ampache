...
<ul class="sb2" id="sb_admin">
  <li class="<?php if (!(filter_has_var(INPUT_COOKIE, 'sb_catalogs'))) { echo 'collapsed'; } else { echo $_COOKIE['sb_catalogs']; } ?>">
  ...
  <?php if (Access::check('interface', '100')) {
    ...
    <li class="<?php if (!(filter_has_var(INPUT_COOKIE, 'sb_access_control'))) { echo 'collapsed'; } else { echo $_COOKIE['sb_access_control']; } ?>">
    ...
    <li class="<?php if (!(filter_has_var(INPUT_COOKIE, 'sb_modules'))) { echo 'collapsed'; } else { echo $_COOKIE['sb_modules']; } ?>">
    ...
    <li class="<?php if (!(filter_has_var(INPUT_COOKIE, 'sb_server_config'))) { echo 'collapsed'; } else { echo $_COOKIE['sb_server_config']; } ?>">
