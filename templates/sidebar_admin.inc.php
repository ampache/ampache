...
<ul class="sb2" id="sb_admin">
  <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Catalogs'); ?>"><?php echo T_('Catalogs'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'catalogs', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_catalogs')) ? $_COOKIE['sb_catalogs'] : 'expanded'); ?></h4>
  ...
  <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('User Tools'); ?>"><?php echo T_('User Tools'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'user_tools', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_user_tools')) ? $_COOKIE['sb_user_tools'] : 'expanded'); ?></h4>
  ...
  <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Access Control'); ?>"><?php echo T_('Access Control'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'access_control', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_access_control')) ? $_COOKIE['sb_access_control'] : 'expanded'); ?></h4>
  ...
  <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Other Tools'); ?>"><?php echo T_('Other Tools'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'ad_other_tools', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_ad_other_tools')) ? $_COOKIE['sb_ad_other_tools'] : 'expanded'); ?></h4>
...
<?php if (Access::check('interface', '100')) {
        ?>
  <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Server Config'); ?>"><?php echo T_('Server Config'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'server_config', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_server_config')) ? $_COOKIE['sb_server_config'] : 'expanded'); ?></h4>
