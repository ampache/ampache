...
<?php if (Access::check('localplay', '25')) {
        ?>
  <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Localplay'); ?>"><?php echo T_('Localplay'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'localplay', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_localplay')) ? $_COOKIE['sb_localplay'] : 'expanded'); ?></h4>
...
<?php
  ...
  <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Active Instance'); ?>"><?php echo T_('Active Instance'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'active_instance', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_active_instance')) ? $_COOKIE['sb_active_instance'] : 'expanded'); ?></h4>
...
<?php
        ...
        ?>
  <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Localplay Disabled'); ?>"><?php echo T_('Localplay Disabled'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'localplay_disabled', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_localplay_disabled')) ? $_COOKIE['sb_localplay_disabled'] : 'expanded'); ?></h4></li>
  <?php if (!$server_allow) {
            ?>
