...
<?php if (Access::check('localplay', '25')) { ?>
  <li class="<?php if (!(filter_has_var(INPUT_COOKIE, 'sb_localplay'))) { echo 'collapsed'; } else { echo $_COOKIE['sb_localplay']; } ?>"><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Localplay'); ?>"><?php echo T_('Localplay'); ?></span><?php echo UI::get_icon('all', T_('Expand/Collapse'), 'localplay', 'header-img'); ?></h4>
...
<?php
  ...
  <li class="<?php if (!(filter_has_var(INPUT_COOKIE, 'sb_active_instance'))) { echo 'collapsed'; } else { echo $_COOKIE['sb_active_instance']; } ?>"><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Active Instance'); ?>"><?php echo T_('Active Instance'); ?></span><?php echo UI::get_icon('all', T_('Expand/Collapse'), 'active_instance', 'header-img'); ?></h4>
...
<?php
  ...
  <li class="<?php if (!(filter_has_var(INPUT_COOKIE, 'sb_localplay_disabled'))) { echo 'collapsed'; } else { echo $_COOKIE['sb_localplay_disabled']; } ?>"><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Localplay Disabled'); ?>"><?php echo T_('Localplay Disabled'); ?></span><?php echo UI::get_icon('all', T_('Expand/Collapse'), 'localplay_disabled', 'header-img'); ?></h4></li>
  <?php if (!$server_allow) { ?>
