...
<tr>
    ...
    <td><?php echo debug_result($environment->check_php_hash()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($environment->check_php_hash_algo()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($environment->check_php_pdo()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($environment->check_php_pdo_mysql()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($environment->check_php_session()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($environment->check_php_json()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($environment->check_php_curl()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($environment->check_php_zlib()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($environment->check_php_simplexml()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($environment->check_php_gd()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($environment->check_override_memory()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($environment->check_override_exec_time()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($environment->check_upload_size()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($environment->check_php_int_size()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($environment->check_php_pdo() && Dba::check_database_inserted()); ?></td>
