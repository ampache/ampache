...
<table class="tabledata" cellpadding="0" cellspacing="0" data-objecttype="album">
    <thead>
        ...
        <?php if (AmpConfig::get('use_id3_band_tag')) {?>
            <th class="cel_album_artist optional"><?php echo Ajax::text('?page=browse&action=set_sort&browse_id=' . $browse->id . '&sort=album_artist', T_('Album Artist'),'album_sort_album_artist'); ?></th>
        <?php } ?>
            <th class="cel_artist essential"><?php echo Ajax::text('?page=browse&action=set_sort&browse_id=' . $browse->id . '&sort=artist', T_('Artist'),'album_sort_artist'); ?></th>
    ...
    <tfoot>
        ...
        <?php } ?>
            ...
            <th class="cel_add"></th>
        <?php if (AmpConfig::get('use_id3_band_tag')) {?>
            <th class="cel_album_artist"><?php echo Ajax::text('?page=browse&action=set_sort&browse_id=' . $browse->id . '&sort=album_artist', T_('Album Artist'),'album_sort_album_artist_bottom'); ?></th>
        <?php } ?>
            <th class="cel_artist"><?php echo Ajax::text('?page=browse&action=set_sort&browse_id=' . $browse->id . '&sort=artist', T_('Artist'),'album_sort_artist_bottom'); ?></th>
