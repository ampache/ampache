...
<ul id="sidebar-light">
    ...
    <li><a target="_top" href="<?php echo $web_path; ?>/logout.php"><img src="<?php echo $web_path ?>/images/topmenu-logout.png" title="<?php echo $t_logout ?>" /><br /><?php echo $t_logout ?></a></li>
</ul>
