    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>
                ...
                <?php echo Ajax::button('?action=cancel_edit_object&id=' . $playlist->id . '&type=smartplaylist_title','cancel', T_('Cancel Changes'),'cancel_playlist_' . $playlist->id,'edit_playlist_' . $playlist->id); ?>
            </td>
        </tr>
    </table>
</form>
