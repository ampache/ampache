...
<li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Modules'); ?>"><?php echo T_('Modules'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'modules', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_modules')) ? $_COOKIE['sb_modules'] : 'expanded'); ?></h4>
  ...
  <li><h4 class="header"><span class="sidebar-header-title" title="<?php echo T_('Other Tools'); ?>"><?php echo T_('Other Tools'); ?></span><?php UI::get_icon('all', T_('Expand/Collapse'), 'md_other_tools', 'header-img ' . (filter_has_var(INPUT_COOKIE, 'sb_md_other_tools')) ? $_COOKIE['sb_md_other_tools'] : 'expanded'); ?></h4>
