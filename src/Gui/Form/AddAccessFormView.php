...
/**
 * The add-an-access-control-entry form.
 */
final class AddAccessFormView extends AbstractFormView
{
    public function __construct(
        string $webPath,
        private readonly string $addType,
    ...
    /**
     * The "add current host" entry seeds both ends with the caller's address.
     */
    ...
    {
        return $this->findTemplate('form/add_access.phtml');
    }
}
