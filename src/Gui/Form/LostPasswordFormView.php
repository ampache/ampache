...
/**
 * The lost-password form; its own document, like the login page.
 */
final class LostPasswordFormView extends AbstractFormView
{
    ...
    public function getMobileSession(): bool
    {
    ...
    {
        return $this->findTemplate('form/lost_password.phtml');
    }
}
