...
/**
 * The album art on its own, in the popup window the thumbnail opens.
 */
final class BigArtView extends AbstractView
{
    ...
    {
        return $this->siteTitle . ' - ' . T_('Album Art');
    }

    #[Override]
    protected function templateFile(): string
    {
        return $this->findTemplate('big_art.phtml');
    }
}
