...
/**
 * The genre cloud, whose buttons filter the browse below it.
 */
final class GenreCloudView extends AbstractView
{
    /**
     * @param array<int, array{id: int, name: string, is_hidden: int, count: int}> $genres
     */
    public function __construct(
        ...
        private readonly ?int $showGenre,
    ) {}
    ...
    /**
     * A genre named in the url is opened for the visitor rather than waiting for a click.
     */
    public function getShowGenre(): ?int
    {
    ...
    {
        return $this->findTemplate('genre_cloud.phtml');
    }
}
