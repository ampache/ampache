...
/**
 * One row of the manage-shoutbox table.
 */
final class ShoutRowView extends AbstractView
{
    public function __construct(
        private readonly string $adminPath,
        private readonly Shoutbox $shout,
        private readonly string $objectLink,
    ...
    {
        return $this->findTemplate('shout_row.phtml');
    }
}
