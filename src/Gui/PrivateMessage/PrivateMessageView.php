 ...
 */
final class PrivateMessageView extends AbstractFormView
{
    ...
    public function getMessage(): PrivateMessageInterface
    {
        return $this->message;
    }
    ...
    {
        return $this->findTemplate('private_message.phtml');
    }
}
