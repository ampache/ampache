...
/**
 * One row of an album-disk browse.
 *
 * Built fresh per row rather than reused with reassigned context, so a value from the previous row cannot
 * survive into the next one.
 */
final class AlbumDiskRowView extends AbstractView
{
    public function __construct(
        private readonly AlbumDiskViewAdapterInterface $albumDisk,
    ...
    public function getAlbumDisk(): AlbumDiskViewAdapterInterface
    {
        return $this->albumDisk;
    }
    ...
    {
        return $this->findTemplate('album_disk_row.phtml');
    }
}
