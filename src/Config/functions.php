...
{
    return ((file_exists(__DIR__ . '/../../public/client/.htaccess') && is_writeable(__DIR__ . '/../../public/client/.htaccess'))
        || (!file_exists(__DIR__ . '/../../public/client/.htaccess') && is_writeable(__DIR__ . '/../../public/client/')));
}
...
function show_now_playing(): void
{
    ...
    echo (new NowPlayingView(Stream::get_now_playing(), AmpConfig::get_web_path('/client')))->render();
}
