...
{
    return ((file_exists(__DIR__ . '/../../jellyfin/.htaccess') && is_writeable(__DIR__ . '/../../jellyfin/.htaccess'))
        || (!file_exists(__DIR__ . '/../../jellyfin/.htaccess') && is_writeable(__DIR__ . '/../../jellyfin/')));
}
