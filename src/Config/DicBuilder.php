...
$builder->addDefinitions(
    ...
    require_once __DIR__ . '/../Module/Folder/service_definition.php',
    ...
    require_once __DIR__ . '/../Module/QuickConnect/service_definition.php',
    ...
    require_once __DIR__ . '/../Module/Pow/service_definition.php',
);
