...
final readonly class InitializationHandlerConfig implements InitializationHandlerInterface
{
    ...
    private const string CONFIG_VERSION = '91';

    private const string STRUCTURE = 'client'; // Project release is using either the public html folder or squashed structure
