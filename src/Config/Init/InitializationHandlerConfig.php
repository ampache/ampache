...
final readonly class InitializationHandlerConfig implements InitializationHandlerInterface
{
    ...
    private const string CONFIG_VERSION = '100'; // AMPACHE_CONFIG_VERSION

    private const string STRUCTURE = 'squashed';

    private const string VERSION = '8.2.0'; // AMPACHE_VERSION
