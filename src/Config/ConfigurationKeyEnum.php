...
final class ConfigurationKeyEnum
{
    ...
    public const string OIDC_AUTHORIZATION_ENDPOINT           = 'oidc_authorization_endpoint';
    public const string OIDC_AUTO_REDIRECT                    = 'oidc_auto_redirect';
    public const string OIDC_BUTTON_TEXT                      = 'oidc_button_text';
    public const string OIDC_CERT_PATH                        = 'oidc_cert_path';
    public const string OIDC_CITY_CLAIM                       = 'oidc_city_claim';
    public const string OIDC_CLIENT_ID                        = 'oidc_client_id';
    public const string OIDC_CLIENT_SECRET                    = 'oidc_client_secret';
    public const string OIDC_DISABLE_SSL_VERIFY               = 'oidc_disable_ssl_verify';
    public const string OIDC_EMAIL_CLAIM                      = 'oidc_email_claim';
    public const string OIDC_END_SESSION_ENDPOINT             = 'oidc_end_session_endpoint';
    public const string OIDC_ISSUER                           = 'oidc_issuer';
    public const string OIDC_JWKS_URI                         = 'oidc_jwks_uri';
    public const string OIDC_NAME_CLAIM                       = 'oidc_name_claim';
    public const string OIDC_SCOPES                           = 'oidc_scopes';
    public const string OIDC_STATE_CLAIM                      = 'oidc_state_claim';
    public const string OIDC_TOKEN_ENDPOINT                   = 'oidc_token_endpoint';
    public const string OIDC_URL                              = 'oidc_url';
    public const string OIDC_USE_USERINFO                     = 'oidc_use_userinfo';
    public const string OIDC_USERINFO_ENDPOINT                = 'oidc_userinfo_endpoint';
    public const string OIDC_USERNAME_CLAIM                   = 'oidc_username_claim';
