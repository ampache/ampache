...
{
    /**
     * Removes collaborator rows whose playlist no longer exists
     *
    ...
    public function collectGarbage(): void
    {
        $this->connection->query(
            "DELETE FROM `user_playlist_map` WHERE `playlist_id` NOT LIKE 'smart\\_%' AND `playlist_id` NOT IN (SELECT `id` FROM `playlist`);"
        );
    }
