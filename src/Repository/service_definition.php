...
return [
    ...
    CatalogFilterRepositoryInterface::class => autowire(CatalogFilterRepository::class),
    CatalogRepositoryInterface::class => autowire(CatalogRepository::class),
    ObjectNameRepositoryInterface::class => autowire(ObjectNameRepository::class),
    CatalogMapRepositoryInterface::class => autowire(CatalogMapRepository::class),
    ...
    SongPreviewRepositoryInterface::class => autowire(SongPreviewRepository::class),
    TmpPlaylistRepositoryInterface::class => autowire(TmpPlaylistRepository::class),
    ...
    TmpBrowseRepositoryInterface::class => autowire(TmpBrowseRepository::class),
