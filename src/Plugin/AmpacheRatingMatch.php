...
class AmpacheRatingMatch
{
    ...
    public function install()
    {
        ...
        Preference::insert('ratingmatch_stars', T_('Minimum star rating to match'), 0, 25, 'integer', 'plugins',
            $this->name);
        Preference::insert('ratingmatch_flags', T_('When you love a track, flag the album and artist'), 0, 25,
            'boolean', 'plugins', $this->name);
