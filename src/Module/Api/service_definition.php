...
return [
    ...
    Method\Lib\ItemToplistMapperInterface::class => autowire(Method\Lib\ItemToplistMapper::class),
    Method\Lib\ArtItemRetrieverInterface::class => autowire(Method\Lib\ArtItemRetriever::class),
