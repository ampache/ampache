...
/** GET/POST /System/Ping — unauthenticated liveness probe; the spec's response schema is a bare JSON string. */
final class SystemPingMethod implements JellyfinMethodInterface
{
