...
/**
 * Legacy Subsonic playback-state endpoints (getNowPlaying, getPlayQueue, getPlayQueueByIndex,
 * jukeboxControl, savePlayQueue, savePlayQueueByIndex, scrobble).
 */
interface PlaybackStateHandlerInterface
{
    /**
