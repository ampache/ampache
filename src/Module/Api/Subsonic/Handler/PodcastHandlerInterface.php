...
/**
 * Legacy Subsonic podcast endpoints (create/delete PodcastChannel, delete/download PodcastEpisode,
 * getNewestPodcasts, getPodcastEpisode, getPodcasts, refreshPodcasts).
 */
interface PodcastHandlerInterface
{
    /**
