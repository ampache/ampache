...
class Json_Data
{
     ...
     *
     * @param  integer[] $objects Licence id's assigned to songs and artists
     * @param  boolean   $object (whether to return as a named object array or regular array)
     ...
     *
     * @param  integer[] $objects Genre id's to include
     * @param  boolean   $object (whether to return as a named object array or regular array)
     ...
     * we want
     *
     * @param  integer[]    $objects Artist id's to include
     * @param  array        $include
     * @param  User         $user
     ...
     *
     * @param  integer[]    $objects Album id's to include
     * @param  array        $include
     * @param  User         $user
     * @param  boolean      $encode
     * @param  boolean      $object (whether to return as a named object array or regular array)
     ...
     *
     * @param  integer[] $objects Share id's to include
     * @param  boolean   $object (whether to return as a named object array or regular array)
        ...
        foreach ($objects as $bookmark_id) {
            ...
            if ($include) {
                ...
                switch ($bookmark_object_type) {
                    case 'song':
                        $JSON[$count]['song'] = self::songs(array($bookmark_object_id), $user, true, false);
                        break;
                    case 'podcast_episode':
                        $JSON[$count]['podcast_episode'] = self::podcast_episodes(array($bookmark_object_id), $user, true, false);
                        break;
                    case 'video':
                        $JSON[$count]['video'] = self::videos(array($bookmark_object_id), $user, false);
                        break;
                }
            }
            $count++;
     ...
     *
     * @param  integer[] $objects group of catalog id's
     * @param  boolean   $object (whether to return as a named object array or regular array)
     ...
     *
     * @param  integer[] $objects Podcast id's to include
     * @param  User      $user
     ...
     * This returns podcasts to the user, in a pretty json document with the information
     *
     * @param  integer[]    $objects Podcast_Episode id's to include
     * @param  User         $user
     * @param  boolean      $encode
     * @param  boolean      $object (whether to return as a named object array or regular array)
