...
{
    /**
     * Per-request bookmark positions, keyed by user id and then song id. See self::songBookmarkPosition().
     *
     ...
     */
    public static function albumDiscTitles(Album $album): array
    {
        $titles = [];
     ...
     * @return string[]
     */
    public static function albumReleaseTypes(Album $album): array
    {
     ...
     * @return string[]
     */
    public static function allowedUsers(Playlist $playlist): array
    {
     ...
     */
    public static function artistImageUrl(Artist $artist): ?string
    {
     ...
     */
    public static function itemDate(?int $year): array
    {
     ...
     */
    public static function songBookmarkPosition(Song $song): ?int
    {
        ...
        if (!array_key_exists($user->id, self::$bookmarkPositions)) {
            $positions = [];
            foreach (self::getBookmarkRepository()->getByUser($user) as $bookmark_id) {
     ...
     */
    public static function songContributors(Song $song): array
    {
     ...
     * @return string[]
     */
    public static function songIsrc(Song $song): array
    {
     ...
     * }
     */
    public static function songReplayGain(Song $song): array
    {
        $gain = [];
     ...
     */
    public static function sortName(?string $name, ?string $fullName): ?string
    {
     ...
     * }|array{}
     */
    public static function structuredLyrics(Song $song, bool $enhanced = false): array
    {
     ...
     */
    public static function userMaxBitRate(User $user): int
    {
