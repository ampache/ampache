...
/**
 * This returns the podcast episodes that have been deleted.
 *
 ...
 */
final class DeletedPodcastEpisodesMethod implements MethodInterface
{
    public const string ACTION = 'deleted_podcast_episodes';
    ...
    public function handle(
        ...
        $response->getBody()->write(
            $output->deleted($apiVersion, 'podcast_episode', $items)
        );
