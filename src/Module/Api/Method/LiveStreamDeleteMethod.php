...
/**
 * Deletes an existing live_stream (radio station)
 */
final class LiveStreamDeleteMethod implements MethodInterface
{
    ...
    public function handle(
        ...
        $liveStream = $this->liveStreamRepository->findById($objectId);
        if ($liveStream === null) {
        ...
        $response->getBody()->write(
            $output->success($apiVersion, 'Deleted live_stream: ' . $objectId)
        );
