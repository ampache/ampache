...
/**
 * Class PodcastEpisode8Method
 * @package Lib\Api8Methods
 */
final class PodcastEpisode8Method
{
    ...
    public static function podcast_episode(array $input, User $user): bool
    {
        ...
        switch ($input['api_format']) {
            case 'json':
                echo Json8_Data::podcast_episodes([$object_id], $user, $input['auth'], false);
                break;
            default:
                echo Xml8_Data::podcast_episodes([$object_id], $user, $input['auth']);
        }
