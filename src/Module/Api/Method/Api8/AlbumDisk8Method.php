...
/**
 * Returns a single album disk
 *
 * Only api version 8 knows about album disks.
 */
final class AlbumDisk8Method implements MethodInterface
{
    public const string ACTION = 'album_disk';
    ...
    public function handle(
        ...
        $albumDisk = $this->modelFactory->createAlbumDisk((int) $objectId);
        if ($albumDisk->isNew()) {
