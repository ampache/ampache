...
/**
 * Class BookmarkEdit8Method
 * @package Lib\Api8Methods
 */
final class BookmarkEdit8Method
{
    ...
    public static function bookmark_edit(array $input, User $user): bool
    {
        ...
        if (empty($results)) {
            /* HINT: Requested object string/id/type ("album", "myusername", "some song title", 1298376) */
            Api::error(ErrorCodeEnum::NOT_FOUND, sprintf('Not Found: %s', $object_id), self::ACTION, 'bookmark', $input['api_format']);
        ...
        switch ($input['api_format']) {
            case 'json':
                echo Json8_Data::bookmarks($results, $input['auth'], $include, false);
                break;
            default:
