...
/**
 * Class Catalog8Method
 * @package Lib\Api8Methods
 */
final class Catalog8Method
{
     ...
     *
     * filter = (string) Catalog ID number
     *
     * @param array{
     *     filter: string,
     *     api_format: string,
    ...
    public static function catalog(array $input, User $user): bool
    {
        ...
        switch ($input['api_format']) {
            case 'json':
                echo Json8_Data::catalogs([$catalog->id], false);
                break;
            default:
                echo Xml8_Data::catalogs([$catalog->id], $user);
        }
