...
/**
 * Class Scrobble8Method
 * @package Lib\Api8Methods
 */
final class Scrobble8Method
{
    ...
    public static function scrobble(array $input, User $user): bool
    {
        ...
        if ($valid === false) {
            ...
            Api::error(ErrorCodeEnum::NOT_FOUND, sprintf('Not Found: %s', $user_id), self::ACTION, 'empty', $input['api_format']);
        ...
        if ($scrobble_id === '') {
            ...
            if ($media->isNew()) {
                /* HINT: Requested object string/id/type ("album", "myusername", "some song title", 1298376) */
                Api::error(ErrorCodeEnum::NOT_FOUND, sprintf('Not Found: %s', $scrobble_id), self::ACTION, 'song', $input['api_format']);
