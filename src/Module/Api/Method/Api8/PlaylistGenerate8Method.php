...
/**
 * Class PlaylistGenerate8Method
 * @package Lib\Api8Methods
 */
final class PlaylistGenerate8Method
{
    ...
    public static function playlist_generate(array $input, User $user): bool
    {
        ...
        if (!in_array($format, ['song', 'index', 'id'])) {
            Api::error(sprintf('Bad Request: %s', $format), ErrorCodeEnum::BAD_REQUEST, self::ACTION, 'type', $input['api_format']);
