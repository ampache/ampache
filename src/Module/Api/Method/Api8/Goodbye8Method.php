...
/**
 * Class Goodbye8Method
 * @package Lib\Api8Methods
 */
final class Goodbye8Method
{
    ...
    public static function goodbye(array $input, User $user): bool
    {
        ...
        Api::error(ErrorCodeEnum::BAD_REQUEST, sprintf('Bad Request: %s', $input['auth']), self::ACTION, 'account', $input['api_format']);
