...
/**
 * Class ShareCreate8Method
 * @package Lib\Api8Methods
 */
final class ShareCreate8Method
{
    ...
    public static function share_create(array $input, User $user): bool
    {
        ...
        if ($objectTypeEnum === null || !in_array($objectTypeEnum, Share::VALID_TYPES, true)) {
            ...
            Api::error(ErrorCodeEnum::BAD_REQUEST, sprintf('Bad Request: %s', $input['type']), self::ACTION, 'type', $input['api_format']);
