...
/**
 * Class LiveStreamCreate8Method
 * @package Lib\Api8Methods
 */
final class LiveStreamCreate8Method
{
    ...
    public static function live_stream_create(array $input, User $user): bool
    {
        ...
        if (!$url) {
            /* HINT: Requested object string/id/type ("album", "myusername", "some song title", 1298376) */
            Api::error(ErrorCodeEnum::BAD_REQUEST, sprintf('Bad Request: %s', $url), self::ACTION, 'url', $input['api_format']);
