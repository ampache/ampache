...
/**
 * Returns the albums of a single genre.
 *
 * Version 5 reads the albums from the tag map instead of browsing them, so it keeps a method of
 * its own.
 */
final class GenreAlbums5Method implements MethodInterface
{
