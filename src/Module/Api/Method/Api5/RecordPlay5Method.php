...
final class RecordPlay5Method
{
    ...
    public static function record_play(array $input): bool
    {
        ...
        if ($play_user->id !== $api_user->id && !Api5::check_access('interface', 100, $api_user->id, self::ACTION, $input['api_format'])) {
            return false;
        }
        ob_end_clean();
        ...
        if ($valid === false) {
            ...
            Api5::error(sprintf(T_('Not Found: %s'), $play_user->id), '4704', self::ACTION, 'user', $input['api_format']);
