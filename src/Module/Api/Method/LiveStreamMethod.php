...
/**
 * Returns a single live_stream based on the UID of said live_stream.
 *
 ...
 */
final class LiveStreamMethod implements MethodInterface
{
    ...
    public function handle(
        ...
        $liveStream = $this->modelFactory->createLiveStream($objectId);
        if ($liveStream->isNew()) {
            throw new ResultEmptyException((string) $objectId);
        }

        $response->getBody()->write(
            $output->liveStreams($apiVersion, [$objectId], $user, false)
        );
