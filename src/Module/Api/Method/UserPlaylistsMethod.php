...
/**
 * Returns the playlists owned by the current user.
 *
 ...
 */
final class UserPlaylistsMethod implements MethodInterface
{
    public const string ACTION = 'user_playlists';
     ...
     *
     * Get the playlists (not smartlists) for the current user
     *
