...
/**
 * Returns the songs that have been deleted from the server.
 *
 ...
 */
final class DeletedSongsMethod implements MethodInterface
{
    ...
    public function handle(
        ...
        $response->getBody()->write(
            $output->deleted($apiVersion, 'song', $results)
        );
