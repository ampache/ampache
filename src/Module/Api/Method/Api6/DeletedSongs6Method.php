...
/**
 * Class DeletedSongs6Method
 * @package Lib\Api6Methods
 */
final class DeletedSongs6Method
{
    ...
    public static function deleted_songs(array $input, User $user): bool
    {
        ...
        if (empty($results)) {
            Api6::empty('deleted_songs', $input['api_format']);
