...
/**
 * Class Licenses6Method
 * @package Lib\Api6Methods
 */
final class Licenses6Method
{
    ...
    public static function licenses(array $input, User $user): bool
    {
        ...
        if (empty($results)) {
            Api6::empty('license', $input['api_format']);
