...
/**
 * Class FriendsTimeline6Method
 * @package Lib\Api6Methods
 */
final class FriendsTimeline6Method
{
    ...
    public static function friends_timeline(array $input, User $user): bool
    {
        ...
        if (empty($results)) {
            Api6::empty('activity', $input['api_format']);
        ...
        switch ($input['api_format']) {
            case 'json':
                echo Json6_Data::timeline($results);
                break;
            default:
                echo Xml6_Data::timeline($results);
        }
