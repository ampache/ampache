...
/**
 * Class Democratic6Method
 * @package Lib\Api6Methods
 */
final class Democratic6Method
{
    ...
    {
        if (!Api6::check_parameter($input, ['method'], self::ACTION)) {
            return false;
        }
        ...
        switch ($input['method']) {
            ...
            case 'playlist':
                ...
                switch ($input['api_format']) {
                    case 'json':
                        echo Json6_Data::democratic($results, $user, $input['auth']);
                        break;
                    default:
                        echo Xml6_Data::democratic($results, $user, $input['auth']);
                }
                break;
            case 'play':
