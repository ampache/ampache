...
/**
 * Class SystemUpdate6Method
 * @package Lib\Api6Methods
 */
final class SystemUpdate6Method
{
    ...
    public static function system_update(array $input, User $user): bool
    {
        ...
        if ($updated) {
            ...
            Api6::message('update successful', $input['api_format']);
            Session::extend($input['auth'], AccessTypeEnum::API->value);

            return true;
        }
        //no update available but you are an admin so tell them
        Api6::message('No update available', $input['api_format']);
