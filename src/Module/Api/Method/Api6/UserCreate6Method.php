...
/**
 * Class UserCreate6Method
 * @package Lib\Api6Methods
 */
final class UserCreate6Method
{
    ...
    public static function user_create(array $input, User $user): bool
    {
        ...
        if (!Api6::check_parameter($input, ['username', 'password', 'email'], self::ACTION)) {
            return false;
        }
        ...
        if ($user_id > 0) {
            Api6::message('successfully created: ' . $username, $input['api_format']);
