...
/**
 * Class Podcast6Method
 * @package Lib\Api6Methods
 */
final class Podcast6Method
{
    ...
    public static function podcast(array $input, User $user): bool
    {
        ...
        switch ($input['api_format']) {
            case 'json':
                echo Json6_Data::podcasts([$object_id], $user, $input['auth'], $episodes, false);
                break;
            default:
                echo Xml6_Data::podcasts([$object_id], $user, $input['auth'], $episodes);
        }
