...
/**
 * Returns a single video based on the UID of said video.
 *
...
final class VideoMethod implements MethodInterface
{
    ...
    /**
     * This returns a single video based on the UID of said video
     *
    ...
    public function handle(
        ...
        $response->getBody()->write(
            $output->videos($apiVersion, [$objectId], $user, $input['auth'], false)
        );
