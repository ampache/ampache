...
/**
 * Returns an index of object ids for a single object type.
 *
 ...
 */
final class IndexMethod implements MethodInterface
{
    ...
    public function handle(
        ...
        $response->getBody()->write(
            $output->index($apiVersion, $results, $type, $user, $include)
        );
