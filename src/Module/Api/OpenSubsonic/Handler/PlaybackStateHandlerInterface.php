...
/**
 * OpenSubsonic playback-state endpoints (getNowPlaying, getPlayQueue, getPlayQueueByIndex,
 * jukeboxControl, reportPlayback, savePlayQueue, savePlayQueueByIndex, scrobble).
 */
