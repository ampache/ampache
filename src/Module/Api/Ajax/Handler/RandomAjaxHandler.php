    ...
    public function handle(User $user): void
    {
        ...
        switch ($action) {
            ...
            case 'playlist':
                ...
                break;
            case 'send_playlist':
                $_SESSION['iframe']['target'] = AmpConfig::get_web_path('/client') . '/stream.php?action=random' . '&random_type=' . scrub_out((string) ($_REQUEST['random_type'] ?? '')) . '&random_id=' . scrub_out((string) ($_REQUEST['random_id'] ?? ''));
