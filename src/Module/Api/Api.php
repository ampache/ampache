...
class Api
{
    ...
    public const METHOD_LIST = [
        ...
        Method\PlaylistAddMethod::REST_ACTION => Method\PlaylistAddMethod::class,
        Method\PlaylistAddSongMethod::ACTION => Method\PlaylistAddSongMethod::class,
        Method\PlaylistAddSongMethod::REST_ACTION => Method\PlaylistAddSongMethod::class,
        ...
        Method\ShareCreateMethod::REST_ACTION => Method\ShareCreateMethod::class,
        ...
        Method\UserEditMethod::REST_ACTION => Method\UserEditMethod::class,
        Method\UserDeleteMethod::ACTION => Method\UserDeleteMethod::class,
        Method\UserDeleteMethod::REST_ACTION => Method\UserDeleteMethod::class,
