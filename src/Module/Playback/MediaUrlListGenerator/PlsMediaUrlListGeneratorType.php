...
final class PlsMediaUrlListGeneratorType extends AbstractMediaUrlListGeneratorType
{
    ...
    public function generate(
        ...
        $ret = "[playlist]\n";
        $ret .= 'NumberOfEntries=' . count($playlist->urls) . "\n";
        $count = 0;
        ...
        return $this
            ->setHeader($response, 'pls', 'audio/x-scpls')
