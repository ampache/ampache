...
final class UserPreferenceRetriever implements UserPreferenceRetrieverInterface
{
     ...
     * @return int|string
     */
    public function retrieve(int $userId, string $preferenceName)
    {
        return $this->userPreferenceRepository->getByUserAndPreference(
            $userId,
            $this->preferenceRepository->getIdByName($preferenceName)
        );
    }
}
