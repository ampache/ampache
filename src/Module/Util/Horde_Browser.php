...
class Horde_Browser
{
    ...
    public function match($userAgent = null, $accept = null): void
    {
        ...
        if ($userAgent == null) {
            if (isset($_SERVER['HTTP_USER_AGENT'])) {
                $this->_agent = trim((string) $_SERVER['HTTP_USER_AGENT']);
            }
        } else {
        ...
        if (isset($_SERVER['HTTP_ACCEPT_CHARSET'])) {
            $this->setFeature('utf', str_contains(strtolower((string) $_SERVER['HTTP_ACCEPT_CHARSET']), 'utf'));
        }

        if ($this->_agent === '' || $this->_agent === '0') {
            return;
        }
        ...
        if (str_contains($lowerAgent, 'iemobile') || str_contains($lowerAgent, 'mobileexplorer') || str_contains($lowerAgent, 'openwave')) {
        ...
        } elseif (str_contains($lowerAgent, 'opera mini') || str_contains($lowerAgent, 'operamini')) {
        ...
        } elseif (str_contains($lowerAgent, 'elaine/') || str_contains($lowerAgent, 'palmsource') || str_contains($lowerAgent, 'digital paths')) {
            ...
            $this->setFeature('javascript', 1.1);
            $this->setQuirk('avoid_popup_windows');
        } elseif (str_contains($lowerAgent, 'avantgo')) {
            ...
            $this->setFeature('javascript', false);
        } elseif (str_contains($agent, 'UP/') || str_contains($agent, 'UP.B') || str_contains($agent, 'UP.L')) {
            $this->setBrowser('up');
            ...
            if (str_contains($agent, 'GUI') && str_contains($agent, 'UP.Link')) {
        ...
        } elseif (str_contains($agent, 'Xiino/')) {
            $this->setBrowser('xiino');
            $this->setFeature('hdml');
            $this->setFeature('wml');
        } elseif (str_contains($agent, 'Palmscape/')) {
            $this->setBrowser('palmscape');
            $this->setFeature('javascript', false);
            $this->setFeature('hdml');
            $this->setFeature('wml');
        } elseif (str_contains($agent, 'Nokia')) {
            $this->setBrowser('nokia');
            $this->setFeature('html', false);
            $this->setFeature('wml');
            $this->setFeature('xhtml');
        } elseif (str_contains($agent, 'Ericsson')) {
            $this->setBrowser('ericsson');
            $this->setFeature('html', false);
            $this->setFeature('wml');
        } elseif (str_contains($agent, 'Grundig')) {
            $this->setBrowser('grundig');
            $this->setFeature('xhtml');
            $this->setFeature('wml');
        } elseif (str_contains($agent, 'NetFront')) {
            $this->setBrowser('netfront');
            $this->setFeature('xhtml');
            $this->setFeature('wml');
        } elseif (str_contains($lowerAgent, 'wap')) {
            $this->setBrowser('wap');
            $this->setFeature('html', false);
            $this->setFeature('javascript', false);
            $this->setFeature('hdml');
            $this->setFeature('wml');
        } elseif (str_contains($lowerAgent, 'docomo') || str_contains($lowerAgent, 'portalmmm')) {
        ...
        } elseif (str_contains($agent, 'MOT-')) {
            $this->setBrowser('motorola');
            $this->setFeature('html', false);
            $this->setFeature('javascript', false);
            $this->setFeature('hdml');
            $this->setFeature('wml');
        } elseif (str_contains($lowerAgent, 'j-')) {
            $this->setBrowser('mml');
        }
    }
    ...
    {
        if (str_contains($this->_lowerAgent, 'wind')) {
            $this->_platform = 'win';
        } elseif (str_contains($this->_lowerAgent, 'mac')) {
            $this->_platform = 'mac';
        } else {
            $this->_platform = 'unix';
        }
