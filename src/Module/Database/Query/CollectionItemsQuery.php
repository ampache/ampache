 ...
 *
 * Like `PlaylistMediaQuery` this builds no SQL: the rows arrive already ordered from `collection_map` and the
 * browse only has to render them. The empty sort list is deliberate -- re-sorting would discard the order the
 * collection exists to record.
 */
final class CollectionItemsQuery implements QueryInterface
{
