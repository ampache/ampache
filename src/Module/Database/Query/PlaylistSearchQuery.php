    ...
    public function get_sql_filter(Query $query, string $filter, mixed $value): string
    {
        ...
        switch ($filter) {
            ...
            case 'hide_dupe_smartlist':
                ...
                break;
            case 'playlist_open':
                $query->set_join_and_and('LEFT', '`user_playlist_map`', '`user_playlist_map`.`playlist_id`', '`playlist`.`id`', '`playlist`.`object_type`', "'playlist'", "`user_playlist_map`.`user_id`", (string)$value, 100);
            ...
            case 'playlist_type':
                ...
                if ($value == 0) {
                    ...
                    $query->set_join_and_and('LEFT', '`user_playlist_map`', '`user_playlist_map`.`playlist_id`', '`playlist`.`id`', '`playlist`.`object_type`', "'playlist'", "`user_playlist_map`.`user_id`", (string)$user_id, 100);
