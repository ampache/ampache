    ...
    public function run(ServerRequestInterface $request, GuiGatekeeperInterface $gatekeeper): ?ResponseInterface
    {
        ...
        if (!$shown) {
            ...
            echo new PodcastEpisodeView(
                ...
                AmpConfig::get('waveform') && Waveform::is_available($episode, 'podcast_episode'),
                $mayInteract,
                (!AmpConfig::get('use_auth') || $mayInteract) && AmpConfig::get('sociable'),
                $mayInteract && AmpConfig::get('share'),
