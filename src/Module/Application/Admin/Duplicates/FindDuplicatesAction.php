...
namespace Ampache\Module\Application\Admin\Duplicates;
...
final class FindDuplicatesAction implements ApplicationActionInterface
{
    public const REQUEST_KEY = 'find_duplicates';
