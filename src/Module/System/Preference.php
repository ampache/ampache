...
class Preference extends database_object
{
    ...
    public const array DEFAULTS = [
        ...
        'generated_art_enabled' => ['0', 'Allow drawn artwork for items that have no cover', AccessLevelEnum::ADMIN->value, 'boolean', 'system', 'interface'],
        'generated_art_over_custom' => ['0', 'Drawn artwork replaces the custom blank album image', AccessLevelEnum::ADMIN->value, 'boolean', 'system', 'interface'],
        'generated_art_template' => ['auto', 'Drawn artwork template', AccessLevelEnum::USER->value, 'string', 'interface', 'theme'],
        'generated_art_template_lock' => ['', 'Force one drawn artwork template for every user', AccessLevelEnum::ADMIN->value, 'string', 'system', 'interface'],
    ...
    public const array PRESETS = [
        'default' => [
            ...
            '' => ['custom_apple_touch_icon', 'custom_share_image', 'generated_art_template_lock', 'api_hidden_playlists', 'autoupdate_lastcheck', 'autoupdate_lastversion_new', 'autoupdate_lastversion', 'custom_blankalbum', 'custom_datetime', 'custom_favicon', 'custom_login_background', 'custom_login_logo', 'custom_logo', 'custom_text_footer', 'custom_timezone', 'daap_pass', 'disabled_custom_metadata_fields_input', 'disabled_custom_metadata_fields', 'lastfm_challenge', 'lastfm_grant_link', 'libitem_browse_alpha', 'site_description', 'upload_script'],
            '0.8' => ['jp_volume'],
            '0' => ['generated_art', 'generated_art_enabled', 'generated_art_over_custom', 'album_sort', 'allow_upload', 'allow_video', 'api_force_version', 'api_hide_dupe_searches', 'bookmark_latest', 'broadcast_by_default', 'catalog_check_duplicate', 'cron_cache', 'custom_logo_user', 'daap_backend', 'demo_clear_sessions', 'demo_use_search', 'direct_play_limit', 'force_http_play', 'geolocation', 'hide_genres', 'hide_single_artist', 'home_moment_videos', 'httpq_active', 'index_dashboard_form', 'lock_songs', 'mpd_active', 'notify_email', 'page_title_icons', 'perpetual_api_session', 'share', 'show_album_artist', 'show_composer', 'show_lyrics', 'show_played_times', 'show_playlist_media_parent', 'show_playlist_username', 'show_skipped_times', 'sidebar_hide_browse', 'sidebar_hide_dashboard', 'sidebar_hide_information', 'sidebar_hide_playlist', 'sidebar_hide_search', 'sidebar_hide_switcher', 'sidebar_hide_video', 'sidebar_light', 'slideshow_time', 'stream_beautiful_url', 'subsonic_always_download', 'topmenu', 'ui_fixed', 'unique_playlist', 'upload_catalog_pattern', 'upload_user_artist', 'upnp_backend', 'use_original_year', 'webdav_backend', 'webplayer_confirmclose', 'webplayer_removeplayed', 'api_always_download'],
    ...
    public const array SYSTEM_LIST = [
        ...
        'generated_art',
        'generated_art_enabled',
        'generated_art_over_custom',
        'generated_art_template',
        'generated_art_template_lock',
    ...
    public static function translate_db(): void
    {
        $pref_array = [
            ...
            'generated_art_enabled' => 'Allow drawn artwork for items that have no cover',
            'generated_art_over_custom' => 'Drawn artwork replaces the custom blank album image',
            'generated_art_template' => 'Drawn artwork template',
            'generated_art_template_lock' => 'Force one drawn artwork template for every user',
