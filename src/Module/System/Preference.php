...
class Preference extends database_object
{
    ...
    public const array DEFAULT_LEVELS = [
        ...
        AccessLevelEnum::ADMIN->value => ['allow_democratic_playback', 'allow_localplay_playback', 'allow_stream_playback', 'allow_upload', 'autoupdate', 'catalog_check_duplicate', 'cron_cache', 'daap_backend', 'daap_pass', 'demo_use_search', 'disabled_custom_metadata_fields_input', 'disabled_custom_metadata_fields', 'download', 'force_http_play', 'jellyfin_backend_enable', 'jellyfin_quickconnect_enable', 'lang', 'localplay_controller', 'localplay_level', 'lock_songs', 'musicbrainz_server', 'musicbrainz_throttle', 'perpetual_api_session', 'playlist_type', 'podcast_keep', 'podcast_new_download', 'rate_limit', 'share_expire', 'share', 'show_header_login', 'site_description', 'site_title', 'stream_beautiful_url', 'subsonic_backend', 'upload_access_level', 'upload_allow_edit', 'upload_allow_remove', 'upload_catalog_pattern', 'upload_catalog', 'upload_script', 'upload_subdir', 'upload_user_artist', 'upnp_backend', 'webdav_backend'],
    ];
    /**
    ...
    public const array DEFAULTS = [
        ...
        'jellyfin_quickconnect_enable' => ['0', 'Use Jellyfin QuickConnect', AccessLevelEnum::ADMIN->value, 'boolean', 'system', 'backend'],
    ...
    public static function translate_db(): void
    {
        $pref_array = [
            ...
            'jellyfin_quickconnect_enable' => 'Use Jellyfin QuickConnect',
