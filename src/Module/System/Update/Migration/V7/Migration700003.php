...
final class Migration700003 extends AbstractMigration
{
    protected array $changelog = ['Convert the remaining MyISAM tables to InnoDB'];
    ...
    public function migrate(): void
    {
        ...
        $this->updateDatabase(sprintf('ALTER TABLE `artist_map` ENGINE=%s;', $engine));
