...
final class Migration700019 extends AbstractMigration
{
    ...
    {
        $this->updatePreferences('api_always_download', 'Force API streams to download. (Enable scrobble in your client to record stats)', '0', AccessLevelEnum::USER->value, 'boolean', 'options', 'api');
        // Group all API & Subsonic options into a single subcategory
