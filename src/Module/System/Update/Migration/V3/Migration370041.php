...
final class Migration370041 extends AbstractMigration
{
    ...
    public function migrate(): void
    {
        ...
        $this->updatePreferences('disabled_custom_metadata_fields', 'Disable custom metadata fields (ctrl / shift click to select multiple)', '', 100, 'string', 'system');
        $this->updatePreferences('disabled_custom_metadata_fields_input', 'Disable custom metadata fields. Insert them in a comma separated list. They will add to the fields selected above.', '', 100, 'string', 'system');
    }
