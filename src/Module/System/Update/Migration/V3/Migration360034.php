 ...
 */
final class Migration360034 extends AbstractMigration
{
    protected array $changelog = ['Add settings for confirmation when closing window and auto-pause between tabs'];
