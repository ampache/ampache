 ...
 */
final class Migration600048 extends AbstractMigration
{
    protected array $changelog = ['Add `date` column to rating table'];

    public function migrate(): void
    {
        $this->updateDatabase('ALTER TABLE `rating` DROP COLUMN `date`');
