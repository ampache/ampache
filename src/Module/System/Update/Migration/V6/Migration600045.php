 ...
 */
final class Migration600045 extends AbstractMigration
{
    protected array $changelog = ['Add column `last_update` and `date`to search table'];

    public function migrate(): void
    {
        Dba::write('ALTER TABLE `search` DROP COLUMN `last_update`;', [], true);
        $this->updateDatabase('ALTER TABLE `search` ADD COLUMN `last_update` int(11) unsigned NOT NULL DEFAULT 0 AFTER `type`;');
        Dba::write('ALTER TABLE `search` DROP COLUMN `date`;', [], true);
