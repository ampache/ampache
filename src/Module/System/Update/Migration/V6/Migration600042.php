 ...
 */
final class Migration600042 extends AbstractMigration
{
    protected array $changelog = ['Add user preference `bookmark_latest`, Only keep the latest media bookmark'];
