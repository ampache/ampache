 ...
 */
final class Migration600025 extends AbstractMigration
{
    protected array $changelog = ['Add ui option (\'show_header_login\') Show the login / registration links in the site header'];
