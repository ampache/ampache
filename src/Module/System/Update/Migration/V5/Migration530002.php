...
final class Migration530002 extends AbstractMigration
{
    ...
    {
        Dba::write("ALTER TABLE `album` DROP COLUMN `song_artist_count`;", [], true);
        $this->updateDatabase("ALTER TABLE `album` ADD COLUMN `song_artist_count` smallint(5) unsigned DEFAULT 0 NULL;");
