 ...
 */
final class Migration520005 extends AbstractMigration
{
    protected array $changelog = ['Add ui option (\'api_hide_dupe_searches\') Hide smartlists that match playlist names in Subsonic and API clients'];
