...
use Ampache\Module\System\Update\Migration\V8\Migration800008;
...
{
    public const int MAXIMUM_UPDATABLE_VERSION = 800009; // AMPACHE_VERSION (db_version)
