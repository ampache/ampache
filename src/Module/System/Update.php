...
class Update
{
    ...
    public static function update_550005(): bool
    {
        ...
        $sql = "INSERT IGNORE INTO `catalog_map` (`catalog_id`, `object_type`, `object_id`) SELECT `catalog`, `map_type`, `artist_id` FROM (SELECT DISTINCT `song`.`catalog`, 'artist' AS `map_type`, `artist_map`.`artist_id` FROM `song` LEFT JOIN `artist_map` ON `song`.`id` = `artist_map`.`object_id` AND `artist_map`.`object_type` = 'song' WHERE `song`.`catalog` > 0 UNION SELECT DISTINCT `album`.`catalog`, 'artist' AS `map_type`, `artist_map`.`artist_id` FROM `album` LEFT JOIN `artist_map` ON `album`.`id` = `artist_map`.`object_id` AND `artist_map`.`object_type` = 'album' WHERE `album`.`catalog` > 0 AND `artist_map`.`object_type` = 'album') AS `artist_map` GROUP BY `catalog`, `artist_map`.`map_type`, `artist_map`.`artist_id`;";
        $retval &= (Dba::write($sql) !== false);
     ...
     */
    public static function update_600004(): bool
    {
        $retval    = true;
        $collation = (AmpConfig::get('database_collation', 'utf8mb4_unicode_ci'));
        $charset   = (AmpConfig::get('database_charset', 'utf8mb4'));
     ...
     */
    public static function update_600005(): bool
    {
     ...
     */
    public static function update_600006(): bool
    {
     ...
     */
    public static function update_600007(): bool
    {
        $retval = true;
     ...
     */
    public static function update_600008(): bool
    {
     ...
     */
    public static function update_600009(): bool
    {
     ...
     */
    public static function update_600010(): bool
    {
        $retval = true;
     ...
     */
    public static function update_600011(): bool
    {
        $retval = true;
     ...
     */
    public static function update_600012(): bool
    {
        $retval = true;
