...
(92, 'allow_personal_info_time', '1', 'Personal information visibility - Recently Played - Allow showing streaming date/time', 25, 'boolean', 'interface', 'privacy'),
(93, 'allow_personal_info_agent', '1', 'Personal information visibility - Recently Played - Allow showing streaming agent', 25, 'boolean', 'interface', 'privacy'),
...
(112, 'upload_catalog', '-1', 'Upload - Destination catalog', 75, 'integer', 'system', 'upload'),
(113, 'allow_upload', '0', 'Upload - Allow user uploads', 75, 'boolean', 'system', 'upload'),
(114, 'upload_subdir', '1', 'Upload - Create a subdirectory per user', 75, 'boolean', 'system', 'upload'),
(115, 'upload_user_artist', '0', 'Upload - Consider the user sender as the track''s artist', 75, 'boolean', 'system', 'upload'),
(116, 'upload_script', '', 'Upload - Post-upload script (current directory = upload target directory)', 75, 'string', 'system', 'upload'),
