...
(112, 'upload_catalog', '-1', 'Uploads - Destination catalog', 75, 'integer', 'system', 'upload'),
(113, 'allow_upload', '0', 'Uploads - Allow user uploads', 75, 'boolean', 'system', 'upload'),
(114, 'upload_subdir', '1', 'Uploads - Create a subdirectory per user', 75, 'boolean', 'system', 'upload'),
(115, 'upload_user_artist', '0', 'Uploads - Consider the user sender as the track''s artist', 75, 'boolean', 'system', 'upload'),
(116, 'upload_script', '', 'Uploads - Post-upload script (current directory = upload target directory)', 75, 'string', 'system', 'upload'),
(117, 'upload_allow_edit', '1', 'Uploads - Allow users to edit uploaded songs', 75, 'boolean', 'system', 'upload'),
...
(135, 'upload_allow_remove', '1', 'Uploads - Allow users to remove uploaded songs', 75, 'boolean', 'system', 'upload'),
