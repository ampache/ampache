...
<div id="information_actions" style="height: 200px;">
    <ul style="float: left;">
        <li>
    ...
    <form style="padding-left: 250px;" method="post" action="<?php echo $web_path; ?>/admin/catalog.php?action=update_from">
        <table class="tabledata2">
            <tr>
                <td><?php /* HINT: /media/path */ ?><?php T_('Add new files from'); ?></td>
                <td><input type="text" name="add_path" value="/" /></td>
            </tr>
            <tr>
                <td><?php /* HINT: /media/path */ ?><?php T_('Clean deleted files in')?></td>
                <td><input type="text" name="clean_path" value="/" /></td>
            </tr>
            <tr>
                <td><?php /* HINT: /media/path */ ?><?php T_('Update existing files in'); ?></td>
                <td><input type="text" name="update_path" value="/" /></td>
            </tr>
            <tr>
                <td><span class="information">/media/path</span></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
