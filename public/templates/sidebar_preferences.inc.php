...
<?php if (!AmpConfig::get('simple_user_mode')) { ?>
    <h4 class="header"><span class="sidebar-header-title"><?php echo T_('Help'); ?></span><img src="<?php echo AmpConfig::get('web_path') . AmpConfig::get('theme_path'); ?>/images/icons/icon_all.png" class="header-img <?php echo (filter_has_var(INPUT_COOKIE, 'sb_help_sections') && $_COOKIE['sb_help_sections'] == 'collapsed') ? 'collapsed' : 'expanded'; ?>" id="help" alt="<?php echo $t_expander; ?>" title="<?php echo $t_expander; ?>" /></h4>
