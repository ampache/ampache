...
$debug_page = $web_path . '/test.php'; ?>
<!DOCTYPE html>
<html lang="en-US">
    <head>
        <!-- Propelled by Ampache | ampache.org -->
        <meta http-equiv="refresh" content="10;URL=<?php echo $debug_page; ?>" />
        ...
        <link rel="stylesheet" href="<?php echo $web_path; ?>/templates/install.css" type="text/css" media="screen">
    </head>
    <body>
        <div class="navbar navbar-dark navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container" style="height: 70px;">
                <a class="navbar-brand" href="<?php echo $web_path; ?>">
        ...
        <div id="guts" class="container" role="main">
            ...
            <div class="alert alert-danger">
                <p><?php echo T_('Something went wrong. Please check the logs for further information.'); ?></p>
                <p><?php echo T_('You will be automatically redirected in 10 seconds.'); ?></p>
                <p><a href="<?php echo $debug_page; ?>"><?php echo T_('Debug Page'); ?></a></p>
            </div>
        </div>
    </body>
</html>
