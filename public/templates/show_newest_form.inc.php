...
<div class="category_options">
    <a class="category <?php echo ($filter_str == 'song') ? 'current' : '' ?>" href="<?php echo $web_path; ?>/stats.php?action=newest_song"><?php echo T_('Songs'); ?></a>
    <?php if ($showAlbum || $filter_str == 'album') { ?>
        <a class="category <?php echo ($filter_str == 'album') ? 'current' : '' ?>" href="<?php echo $web_path; ?>/stats.php?action=newest_album"><?php echo T_('Albums'); ?></a>
    <?php } ?>
    <?php if (!$showAlbum || $filter_str == 'album_disk') { ?>
        <a class="category <?php echo ($filter_str == 'album_disk') ? 'current' : '' ?>" href="<?php echo $web_path; ?>/stats.php?action=newest_album_disk"><?php echo T_('Albums'); ?></a>
    <?php } ?>
    <?php if ($showArtist || $filter_str == 'artist') { ?>
        <a class="category <?php echo ($filter_str == 'artist') ? 'current' : '' ?>" href="<?php echo $web_path; ?>/stats.php?action=newest_artist"><?php echo T_('Artists'); ?></a>
    <?php } ?>
    ...
    if (AmpConfig::get('allow_video') && $videoRepository->getItemCount(Video::class)) { ?>
        <a class="category <?php echo ($filter_str == 'video') ? 'current' : '' ?>" href="<?php echo $web_path; ?>/stats.php?action=newest_video"><?php echo T_('Videos'); ?></a>
    <?php } ?>
</div>
