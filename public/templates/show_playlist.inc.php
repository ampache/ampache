...
<div id="information_actions">
    ...
    <?php if ($playlist->has_access()) { ?>
        ...
        if ($search_id > 0) { ?>
            <li>
                <a href="<?php echo AmpConfig::get('web_path'); ?>/playlist.php?action=refresh_playlist&type=playlist&id=<?php echo $playlist->id; ?>&search_id=<?php echo $search_id; ?>&user_id=<?php echo $playlist->user; ?>">
