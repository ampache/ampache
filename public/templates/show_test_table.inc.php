...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_php_version()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_dependencies_folder()); ?></td>
    <td>
    <?php echo T_('This tests whether Ampache dependencies are installed.'); ?>
    <?php if (!$envChecker->check_dependencies_folder()) { ?>
        <br />
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_php_hash()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_php_hash_algo()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_php_pdo()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_php_pdo_mysql()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_php_session()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_php_json()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($envChecker->check_php_intl()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($envChecker->check_php_curl()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($envChecker->check_php_zlib()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($envChecker->check_php_simplexml()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($envChecker->check_php_gd()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($envChecker->check_override_memory()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($envChecker->check_override_exec_time()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($envChecker->check_upload_size()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_wresult($envChecker->check_php_int_size()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_mbstring_func_overload()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_php_pdo() && Dba::check_database()); ?></td>
...
<tr>
    ...
    <td><?php echo debug_result($envChecker->check_php_pdo() && Dba::check_database_inserted()); ?></td>
