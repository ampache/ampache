...
<?php
    echo Ajax::button('?action=basket&type=podcast&id=' . $libitem->getId(), 'new_window', T_('Add to Temporary Playlist'), 'add_' . $libitem->getId());
if (Access::check(AccessTypeEnum::INTERFACE, AccessLevelEnum::USER)) { ?>
        <a id="<?php echo 'add_to_playlist_' . $libitem->getId(); ?>" onclick="showPlaylistDialog(event, 'podcast', '<?php echo $libitem->getId(); ?>')">
...
if (Access::check(AccessTypeEnum::INTERFACE, AccessLevelEnum::MANAGER)) { ?>
    <a id="<?php echo 'delete_podcast_' . $libitem->getId(); ?>" href="<?php echo AmpConfig::get_web_path(); ?>/podcast.php?action=delete&podcast_id=<?php echo $libitem->getId(); ?>">
