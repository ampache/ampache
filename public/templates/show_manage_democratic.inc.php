...
<table class="tabledata striped-rows">
    ...
    <tr>
        ...
        <a href="<?php echo AmpConfig::get('web_path'); ?>/democratic.php?action=delete&democratic_id=<?php echo scrub_out((string)$democratic->id); ?>"><?php echo Ui::get_material_symbol('close', T_('Delete')); ?></a>
        </td>
    </tr>
    <?php
        } if (!count($playlists)) { ?>
