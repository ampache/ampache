    ...
    <?php
        if (AmpConfig::get('directplay')) {
            ...
            if (Stream_Playlist::check_autoplay_append()) {
                echo Ajax::button('?page=stream&action=directplay&object_type=tvshow_season&object_id=' . $libitem->id . '&append=true', 'low_priority', T_('Play last'), 'addplay_season_' . $libitem->id);
            }
        } ?>
    </div>
</td>
