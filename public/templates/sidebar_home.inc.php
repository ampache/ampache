...
<ul class="sb2" id="sb_home">
    ...
    <li class="sb2_music"><h4 class="header"><span class="sidebar-header-title"><?php echo T_('Browse'); ?></span><?php echo Ui::get_icon('all', $t_expander, 'browse_music', 'header-img ' . (($_COOKIE['sb_browse_music'] == 'collapsed') ? 'collapsed' : 'expanded')); ?></h4>
        <?php
    ...
    <li class="sb2_dashboard">
        <h4 class="header"><span class="sidebar-header-title"><?php echo T_('Dashboards'); ?></span><?php echo Ui::get_icon('all', $t_expander, 'dashboard', 'header-img ' . (($_COOKIE['sb_dashboard'] == 'collapsed') ? 'collapsed' : 'expanded')); ?></h4>
        <ul class="sb3" id="sb_home_dash" style="<?php if (!(filter_has_var(INPUT_COOKIE, 'sb_dashboard'))) {
            ...
            <?php if ($allowPodcast) { ?>
                <li id="sb_home_info_highest"><a href="<?php echo $web_path ?>/mashup.php?action=podcast_episode"><?php echo T_('Podcast Episodes') ?></a></li>
            <?php } ?>
            <?php if ($allowVideo) { ?>
    ...
    <li class="sb2_search">
        ...
        <ul class="sb3" id="sb_home_search" style="<?php if (!(filter_has_var(INPUT_COOKIE, 'sb_search'))) {
          ...
          <?php } ?>
              <li id="sb_home_random_advanced"><a href="<?php echo $web_path; ?>/random.php?action=advanced&type=song"><?php echo T_('Random'); ?></a></li>
        </ul>
    </li>
