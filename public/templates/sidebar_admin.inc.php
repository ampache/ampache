...
<ul class="sb2" id="sb_admin">
  ...
  <li>
    <h4 class="header"><span class="sidebar-header-title"><?php echo T_('Catalogs'); ?></span><?php echo Ui::get_icon('all', $t_expander, 'catalogs', 'header-img ' . ((isset($_COOKIE['sb_catalogs'])) ? $_COOKIE['sb_catalogs'] : 'expanded')); ?></h4>
    <ul class="sb3" id="sb_admin_catalogs">
      ...
      <?php if (AmpConfig::get('catalog_filter')) { ?>
        ...
        <li id="sb_admin_filter_Browse"><a href="<?php echo $web_path; ?>/admin/filter.php?action=browse_catalog_filters"><?php echo T_('Manage Catalog Filters'); ?></a></li>
      <?php } ?>
  ...
  <?php if (Access::check('interface', 100)) { ?>
    <li>
      <h4 class="header"><span class="sidebar-header-title"><?php echo T_('User Tools'); ?></span><?php echo Ui::get_icon('all', $t_expander, 'user_tools', 'header-img ' . ((isset($_COOKIE['sb_user_tools'])) ? $_COOKIE['sb_user_tools'] : 'expanded')); ?></h4>
    ...
    <li>
      <h4 class="header"><span class="sidebar-header-title"><?php echo T_('Access Control'); ?></span><?php echo Ui::get_icon('all', $t_expander, 'access_control', 'header-img ' . ((isset($_COOKIE['sb_access_control'])) ? $_COOKIE['sb_access_control'] : 'expanded')); ?></h4>
