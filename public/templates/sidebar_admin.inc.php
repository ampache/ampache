  ...
  <li>
    ...
    <ul class="sb3" id="sb_admin_catalogs" <?php echo ($state_admin_catalogs == 'collapsed') ? 'style="display: none;"' : ''; ?>>
      ...
      <?php if (AmpConfig::get('catalog_filter')) { ?>
        <li id="sb_admin_filter_Add"><a href="<?php echo $admin_path; ?>/filter.php?action=show_add_filter"><?php echo T_('Add Catalog Filter'); ?></a></li>
        <li id="sb_admin_filter_Browse"><a href="<?php echo $admin_path; ?>/filter.php"><?php echo T_('Show Catalog Filters'); ?></a></li>
      <?php } ?>
      <?php if (AmpConfig::get('licensing')) { ?>
        <li id="sb_admin_ot_ManageLicense"><a href="<?php echo $admin_path; ?>/license.php"><?php echo T_('Manage Licenses'); ?></a></li>
      <?php } ?>
    </ul>
  </li>
  ...
  <li>
      ...
      <ul class="sb3" id="sb_admin_users" <?php echo ($state_admin_users == 'collapsed') ? 'style="display: none;"' : ''; ?>>
        ...
        <?php if (Mailer::is_mail_enabled()) { ?>
          <li id="sb_admin_ot_Mail"><a href="<?php echo $admin_path; ?>/mail.php"><?php echo T_('E-mail Users'); ?></a></li>
        <?php
        }
      if (AmpConfig::get('allow_upload')) { ?>
            <li id="sb_admin_users_Uploads"><a href="<?php echo $admin_path; ?>/uploads.php"><?php echo T_('Browse Uploads'); ?></a></li>
        <?php
      }
      if (AmpConfig::get('sociable')) { ?>
          <li id="sb_admin_ot_ManageShoutbox"><a href="<?php echo $admin_path; ?>/shout.php"><?php echo T_('Manage Shoutbox'); ?></a></li>
        <?php } ?>
        <li id="sb_admin_ot_ClearNowPlaying"><a href="<?php echo $admin_path; ?>/catalog.php?action=clear_now_playing"><?php echo T_('Clear Now Playing'); ?></a></li>
      </ul>
  </li>
  <li>
    <h4 class="header">
