...
// show_random_album_disks.inc.php
...
if (!empty($albumDisks)) {
    ...
    <div class="random_album">
        <div id="album_disk_<?php echo $album_disk_id; ?>" class="art_album libitem_menu" data-object-type="album_disk" data-object-id="<?php echo $album_disk_id; ?>">
