...
if (!isset($libitem->enabled) || $libitem->enabled || Access::check(AccessTypeEnum::INTERFACE, AccessLevelEnum::CONTENT_MANAGER)) {
    $thumb = (isset($browse) && $browse->is_grid_view()) ? ['width' => 150, 'height' => 150] : ['width' => 80, 'height' => 80];
...
<td class="cel_action">
    ...
    <a class="nohtml" href="<?php echo AmpConfig::get_web_path('/client'); ?>/stream.php?action=download&<?php echo $object_type; ?>_id=<?php echo $libitem->getId(); ?>">
