...
<tr id="license_<?php echo $libitem->getId(); ?>">
    ...
    <td class="cel_action">
        <a href="<?php echo $base_path; ?>/admin/license.php?action=show_edit&license_id=<?php echo $libitem->getId(); ?>">
            <?php echo Ui::get_material_symbol('edit', T_('Edit')); ?>
        </a>
        <a href="<?php echo $base_path; ?>/admin/license.php?action=delete&license_id=<?php echo $libitem->getId(); ?>">
