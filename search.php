...
switch ($_REQUEST['action']) {
    ...
    case 'save_as_smartplaylist':
        ...
        $playlist->save();
        show_confirmation(T_('Search has been saved.'), sprintf(T_('Your search has been saved as a Smart Playlist with the name %s'), $playlist->name), AmpConfig::get('web_path') . "/browse.php?action=smartplaylist");
    break;
    case 'descriptor':
