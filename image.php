...
if (AmpConfig::get('use_auth') && AmpConfig::get('require_session')) {
    ...
    $token_check = Auth::token_check('api', $_REQUEST['u'], $_REQUEST['t'], $_REQUEST['s']);
    if (!Session::exists('interface', $_COOKIE[AmpConfig::get('session_name')]) && !Session::exists('api', $_REQUEST['auth']) && !empty($token_check)) {
