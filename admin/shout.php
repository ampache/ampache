...
switch ($_REQUEST['action']) {
    case 'edit_shout':
        ...
        show_confirmation(T_('Shoutbox post has been updated.'), '', AmpConfig::get('web_path') . '/admin/shout.php');
    break;
    case 'show_edit':
        $shout  = new Shoutbox($_REQUEST['shout_id']);
    ...
    case 'delete':
        ...
        show_confirmation(T_('Shoutbox post has been deleted.'), '', AmpConfig::get('web_path') . '/admin/shout.php');
    break;
    default:
        $browse = new Browse();
