...
switch ($_REQUEST['action']) {
    case 'edit_shout':
        ...
        show_confirmation(sprintf(T_('%s has been updated.'), T_('Shoutbox Post')), '', AmpConfig::get('web_path') . '/admin/shout.php');
    break;
    case 'show_edit':
        $shout  = new Shoutbox($_REQUEST['shout_id']);
    ...
    case 'delete':
        ...
        show_confirmation(sprintf(T_('%s has been deleted.'), T_('Shoutbox Post')), '', AmpConfig::get('web_path') . '/admin/shout.php');
    break;
    default:
        $browse = new Browse();
